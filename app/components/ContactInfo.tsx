...
function ContactInfo() {
  ...
  return (
    <div
      ...
      } flex-col pt-[310px]  h-[100vh] overflow-scroll justify-center content-center text-center  global-width absolute z-100 bg-black  `}
    >
      ...
      <div className="flex flex-col justify-center items-start  color-lvl-1 m-4 p-2  rounded-2xl ">
        <h3 className=" text-2xl txt-color-lvl-2 text-quick-500 mx-4 ">
          About :
        </h3>
        <p className=" text-md txt-color-lvl-3_5 text-quick-500 m-4">hello</p>
      </div>
      {/* ..................media,link........... */}
      <div className="flex flex-col justify-around items-start  color-lvl-1 m-4 p-2  rounded-2xl  ">
        <div className="flex justify-center self-start items-start h-[4rem] w-[100%] ">
          <h3 className="text-xl txt-color-lvl-2 text-left text-quick-500 w-[80%] mx-4 p-2">
            Media , links and docs{" "}
          </h3>
          <div className="flex  p-2 w-[20%]">
            <p className=" text-lg txt-color-lvl-2 text-quick-600 ">157 </p>
            <button className=" text-xl txt-color-lvl-2 text-quick-600 ">
              <ARight />
            </button>
          </div>
        </div>
        <div className="text-xl txt-color-lvl-3_5 text-quick-600 mt-0 px-2 m-4">
          ...
        </div>
      </div>
      {/* ..........chat settings......... */}
      <div>
        <div className="text-xl txt-color-lvl-3 color-lvl-1 rounded-2xl py-4 text-quick-600 mt-0 px-2 m-4">
      ...
      <div className=" flex flex-col justify-start content-center items-start  txt-color-lvl-3_5 color-lvl-1 rounded-2xl py-4   mt-0 px-2 m-4">
        <h4 className="text-xl txt-color-lvl-2 text-quick-600 mt-0 px-2 m-4">
          1 group in common
        </h4>
        <div>
          <p className="txt-color-lvl-3 text-lg text-quick-600 ml-6">
            group abc
          </p>
        </div>
      </div>
      {/* .......additional settings......... */}
      <div className="text-xl txt-color-lvl-3_5 color-lvl-1 rounded-2xl py-4 text-quick-600 mt-0 px-2 m-4">
