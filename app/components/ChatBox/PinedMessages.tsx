...
function PinedMessages() {
  ...
  return (
    <div className={`${content.length ==0 ? "hidden" : "flex flex-col"} h-fit w-full `} onClick={()=>handleSubmit}>
        <div className="divider m-0" />
        <p className="text-quick-500 txt-color-lvl-3">{content.length} messages pinned</p>
