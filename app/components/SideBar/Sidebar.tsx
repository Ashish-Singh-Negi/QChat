    ...
    <div className="h-[100vh] sB_w flex flex-col justify-between lg:w-[5vw] color-lvl-1  border-r-2 mr-[3px] border-slate-50  border-opacity-5">
      ...
      <div className="flex flex-col  mb-6 items-center ">
        <button
          ...
          className="text-xl mb-2 txt-color-lvl-3 hover:bg-slate-50 hover:bg-opacity-15 rounded-full  p-4 content-center text-center"
        >
          <Setting />
        </button>
        <button
          onClick={() => setProfile(true)}
          className=" size-9  hover:bg-slate-50 hover:bg-opacity-15 rounded-full  overflow-hidden   text-center"
        >
