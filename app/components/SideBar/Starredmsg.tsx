...
function Starredmsg() {
  ...
  return (
    <div className='flex flex-col  relative hover:bg-slate-50 hover:bg-opacity-20 pb-1 '>
      ...
      <div className='flex items-center ml-2 text-quick-400  '>Kit <ARight className='text-xs mx-1'/> You</div>
      <div className='flex items-center text-sm text-quick-500'>3/4/2025 <Down className='-rotate-90 mx-2' /> </div>
      </div>
        </div>
        <div className=' mr-3 '>

    {recieved ? <Recieved css="" message={data1}/>  : <Sent css="" message={data1} />
    }
        </div>
    </div>
  )
